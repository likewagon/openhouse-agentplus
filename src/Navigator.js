...
function ClientStack() {
  return (
    <Stack.Navigator initialRouteName="ClientList" headerMode="none">
      <Stack.Screen name="ClientList" component={ClientListScreen} />
      <Stack.Screen name="ClientInvite" component={ClientInviteScreen} />
      <Stack.Screen name="ClientShare" component={ClientShareScreen} />
      <Stack.Screen name="ClientMap" component={ClientMapScreen} />
      <Stack.Screen name="ClientView" component={ClientViewScreen} />
      <Stack.Screen name="ClientViewPDF" component={ClientViewPDFScreen} />
      <Stack.Screen
...
function AgentStack() {
  return (
    <Stack.Navigator initialRouteName="AgentListing" headerMode="none">
      <Stack.Screen name="AgentListing" component={AgentListingScreen} />
      <Stack.Screen name="AgentListingMap" component={AgentListingMapScreen} />
    </Stack.Navigator>
  );
}
...
function PropertyStack() {
  return (
    <Stack.Navigator initialRouteName="Property" headerMode="none">
...
function SettingStack() {
  return (
    <Stack.Navigator initialRouteName="MlsSettingLink" headerMode="none">
      <Stack.Screen name="MlsSettingLink" component={MlsSettingLinkScreen} />
      <Stack.Screen
...
function OpenHouseStack() {
  return (
    <Stack.Navigator initialRouteName="OpenHouseHome" headerMode="none">
      <Stack.Screen name="OpenHouseHome" component={OpenHouseHomeScreen} />
      <Stack.Screen
        name="OpenHouseQuestion"
        component={OpenHouseQuestionScreen}
      />
      <Stack.Screen name="OpenHouseSignin" component={OpenHouseSigninScreen} />
      <Stack.Screen
...
function MainStack() {
  return (
    <Stack.Navigator initialRouteName="Dashboard" headerMode="none">
      ...
      <Stack.Screen name="PropertyStack" component={PropertyStack} />
      <Stack.Screen name="SettingStack" component={SettingStack} />
      <Stack.Screen name="OpenHouseStack" component={OpenHouseStack} />
